    ...
    return (
      <button
        ...
        className={clsx(
          ...
          {
            'bg-brand-600 text-white hover:bg-brand-700 focus:ring-brand-300': variant === 'primary',
            'bg-white text-brand-700 border border-gray-200 hover:bg-gray-50 focus:ring-brand-300': variant === 'secondary',
